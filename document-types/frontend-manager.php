...
class Frontend_Manager {
	...
	public function render_location_html( $location = false, $container_tag = 'div', $location_html = false ) {
		...
		echo sprintf( '<%1$s id="jet-theme-core-%2$s" class="%4$s jet-theme-core-location jet-theme-core-location--%2$s-location"><div class="jet-theme-core-location__inner">%3$s</div></%1$s>',
			$container_tag,
			$location,
			$location_html,
            $columns
