...
function kb_post_format_checker() {
    ...
    $tips_tricks  = '<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><g opacity="0.5"><path d="M20 3H4C2.9 3 2 3.9 2 5V23L6 19H20C21.1 19 22 18.1 22 17V5C22 3.9 21.1 3 20 3ZM13.57 12.57L12 16L10.43 12.57L7 11L10.43 9.43L12 6L13.57 9.43L17 11L13.57 12.57Z" fill="#0CB6B3"/></g></svg>';
