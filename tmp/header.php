        ...
        <div class="container">
            ...
            <div class="d-flex flex-column flex-xl-row-reverse align-items-center justify-content-between mt-40 mt-xl-20">
                ...
                <ul class="list d-flex flex-wrap justify-content-center justify-content-md-start m-0 custom-navigation custom-navigation-jetpopup mt-32 mt-md-20 mt-xl-0">
                    ...
                    <li><a class="d-block text-font-sec font-weight-bold py-12 py-md-24 px-12 px-md-16 custom-navigation-link <?php echo $ts_class;?>" href="<?php echo home_url( '/troubleshooting/' )?>">Troubleshooting</a></li>
                    <li><a class="d-block text-font-sec font-weight-bold py-12 py-md-24 px-12 px-md-16 custom-navigation-link active-support" href="https://crocoblock.com/?page_id=71433&preview=true">Support</a></li>
                    <li><a class="d-block text-font-sec font-weight-bold py-12 py-md-24 px-12 px-md-16 custom-navigation-link active-blog" href="https://crocoblock.com/blog/">Blog</a></li>
                </ul>
            </div>
        </div>
    </section>
